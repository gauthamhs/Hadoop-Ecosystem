//Convert this MR job into a jar file before running it using Oozie Workflow
...
//$ hadoop jar converted_MapReduce_jar_file input_file_location_LINUX output_file_location_HDFS
...
public class MapReduceWordCount {
   ...
   // The output of mapper :
	...
	public static void main(String args[]) throws Exception{
		...
		JobConf conf = new JobConf(MapReduceWordCount.class); //JobConf will tell the Hadoop Framework to execute MR Job.
		...
		FileInputFormat.setInputPaths(conf, new Path(args[0])); //The file on which you want to run 
		                                                        //this MapReduce Job. Hadoop will not know, specify input.
